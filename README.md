...
> 🎯 SDG-Track addresses the resolution-speed conflict in edge-based UAV tracking. Its Observer-Follower architecture combines accurate low-frequency GPU detection with high-speed CPU optical flow.

---
## 🙌 Support

- If this project is helpful to you, you are welcome ⭐️ Star！
---

## 📢 Latest Updates
- **Dec-5-25**： **SDG-Track Paper[arXiv](https://arxiv.org/abs/2512.04883) is released.**
